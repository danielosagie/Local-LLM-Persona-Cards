...
with persona_viewer_tab:
    ...
    if 'persona_viewer_data' in st.session_state and st.session_state['persona_viewer_data']:
        ...
        st.markdown('<div class="beta-thrive-card"><div class="beta-thrive-card-v">', unsafe_allow_html=True)
        ...
        with col1:
            # Quote section
            st.markdown(f'''
                <div class="card-section quote">
                    <div class="name">{persona.get("Name", "Unknown")}</div>
                    <p class="quote-content">{persona.get("Description", "No description available.")}</p>
                </div>
            ...
            st.markdown(f'''
                <div class="card-section">
                    <div class="edit-button">
                        <img class="edit-icon" src="GTRI Logo.png" />
                        <div class="section-title">Goals</div>
                    </div>
                    <div class="tag-container">
                        {' '.join(f'<div class="pill"><div class="pill-text">{goal}</div></div>' for goal in persona.get("Goals", []))}
                    </div>
                </div>
            ''', unsafe_allow_html=True)
            ...
            st.markdown(f'''
                <div class="card-section">
                    <div class="section-title">Living Experience</div>
                    <div class="tag-container">
                        {' '.join(f'<div class="pill"><div class="pill-text">{exp}</div></div>' for exp in persona.get("Experience", []))}
                    </div>
                </div>
            ''', unsafe_allow_html=True)
        ...
        with col2:
            ...
            st.markdown(f'''
                <div class="card-section">
                    ...
                    <div class="tag-container">
                        {' '.join(f'<div class="pill"><div class="pill-text">{qual}</div></div>' for qual in persona.get("Qualifications", []))}
                    </div>
                </div>
            ''', unsafe_allow_html=True)
            ...
            st.markdown(f'''
                <div class="card-section">
                    ...
                    <div class="tag-container">
                        {' '.join(f'<div class="pill"><div class="pill-text">{skill}</div></div>' for skill in persona.get("Skills", []))}
                    </div>
                </div>
            ''', unsafe_allow_html=True)
            ...
            st.markdown(f'''
                <div class="card-section">
                    ...
                    <div class="tag-container">
                        {' '.join(f'<div class="pill"><div class="pill-text">{strength}</div></div>' for strength in persona.get("Strengths", []))}
                    </div>
                </div>
            ''', unsafe_allow_html=True)
            ...
            st.markdown(f'''
                <div class="card-section">
                    ...
                    <div class="tag-container">
                        {' '.join(f'<div class="pill"><div class="pill-text">{opp}</div></div>' for opp in persona.get("Values", []))}
                    </div>
                </div>
            ''', unsafe_allow_html=True)

        st.markdown('</div></div>', unsafe_allow_html=True)  # Close beta-thrive-card-v and beta-thrive-card
